<script>
	...
	let steps = [
		{ name: 'BTC Manipulation Checker', icon: 'fa-brands fa-bitcoin' },
		{ name: 'Crushing Reality', icon: 'fa-solid fa-gamepad' },
		{ name: 'ATR-SB Indicator', icon: 'fa-solid fa-chart-column' },
		{ name: 'Algorithm Visualizer', icon: 'fa-regular fa-eye' },
		{ name: 'Leairn', icon: 'fa-solid fa-graduation-cap' }
	];
	let benefits = [
		{
			metric: '10x',
...
<main class="flex flex-col flex-1 p-4">
	<section id="introPage" class="grid grid-cols-1 lg:grid-cols-2 gap-10 py-8 sm:py-14">
		<div class="flex flex-col lg:justify-center text-center lg:text-left pag-6 md:gap-8 lg:gap-10">
			...
			<a
				href="https://github.com/TheMikerik"
		...
		<div class="relative shadow-2xl grid plce-items-center">
			<img src={'images/profile.png'} alt="" class="object-cover z-[2] max-h-[70vh]" />
		</div>
	</section>
	<section id="projects" class="py-20 lg:py-32 flex flex-col gap-24">
		...
		<div class="grid grid-cols lg:grid-cols-3 gap-14 lg:gap-20">
			<Step step={steps[0]}>
				<p>
